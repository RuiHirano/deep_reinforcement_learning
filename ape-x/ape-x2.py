...
import sys
sys.path.append('./../')
from lib2.learner import Learner, LearnerParameter
from lib2.replay import Replay, ReplayParameter
from lib2.actor import Actor, ActorParameter
from lib2.trainer import Trainer, TrainerParameter
from lib2.tester import Tester, TesterParameter
from lib2.weights import Weights
from lib2.util import Color
...
if __name__ == "__main__":
    ...
    '''weightの作成'''
    weights = Weights.remote(net.state_dict())


    '''replayの作成'''
    replay = Replay.remote(ReplayParameter(
        capacity=10000,
        epsilon=0.0001,
        alpha=0.6
    ))
